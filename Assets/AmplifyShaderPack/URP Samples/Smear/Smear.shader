	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 worldToObj123 = mul( GetWorldToObjectMatrix(), float4( finalVertexWorldPosition80, 1 ) ).xyz;
				...
				#endif
				float3 vertexValue = worldToObj123;
				#ifdef ASE_ABSOLUTE_VERTEX_POS
...
/*ASEBEGIN
Version=18920
-2292;79;1316;538;-1817.615;-449.1548;1;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;65;1722.855,498.3999;Inherit;False;1166.783;452.0805;Add the bulge to the final position and convert the result to object space;5;80;39;40;48;123;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.TransformPositionNode;123;2569.615,706.1548;Inherit;False;World;Object;False;Fast;True;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
WireConnection;118;8;123;0
ASEEND*/
//CHKSM=5D01C2CC638DE34AE4731825FB9C7041AE3FE6E5